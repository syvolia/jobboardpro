...
function Home() {
    ...
    const filteredJobs = SAMPLE_JOBS.filter((job)=>{
        // Search query filter
        if (searchQuery && !job.jobTitle.toLowerCase().includes(searchQuery.toLowerCase()) && !job.companyName.toLowerCase().includes(searchQuery.toLowerCase())) {
            return false;
        }
        // Location filter
...
//# sourceMappingURL=Downloads_jobboardpro_ef304443._.js.map