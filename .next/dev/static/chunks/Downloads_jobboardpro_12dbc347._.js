...
function JobListingCard({ id, companyName, companyLogo, jobTitle, jobType, remoteLevel, location, salaryMin, salaryMax, salaryPeriod, techStack, postedDate, source, sourceUrl, isSaved = false, onSave, onApply }) {
    ...
    const handleSave = async ()=>{
        ...
        try {
            if (saved) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$jobboardpro$2f$services$2f$jobService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JobService"].unsaveJob(user.id, id);
                setSaved(false);
                onSave?.(id, false);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$jobboardpro$2f$services$2f$jobService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JobService"].saveJob(user.id, id);
                setSaved(true);
                onSave?.(id, true);
            }
        } catch (error) {
    ...
    const handleApply = async ()=>{
        ...
        setApplying(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$jobboardpro$2f$services$2f$jobService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JobService"].applyToJob(user.id, id);
...
_s(SavedJobsPage, "rkRYOUR9xaII/wj4SGRGbqiFuc0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$jobboardpro$2f$contexts$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"]
    ];
});
...
//# sourceMappingURL=Downloads_jobboardpro_12dbc347._.js.map